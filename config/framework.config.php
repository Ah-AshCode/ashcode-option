...
// ===============================================================================================
$settings           = array(
  'menu_title'      => 'ASHCODE PANEL',
  'menu_type'       => 'submenu', // menu, submenu, options, theme, etc.
  'menu_slug'       => 'ash-framework',
  'ajax_save'       => false,
  'show_reset_all'  => false,
  'framework_title' => 'ASHCODE PANEL <small>by ASH CODE</small>',
);
...
$options[]      = array(
  ...
  'fields'      => array(
    ...
    // begin: a field
        array(
          'id'        => 'unique_typography_7',
          'type'      => 'typography',
          'title'     => 'Typography with Default',
          'desc'      => 'Select the order in which the header elements will be arranged',
          'default'   => array(
          'family'  => 'Arial',
          'font'    => 'google',
          'size'    => '',
    ...
    array(
      ...
      'title'   => 'Number',
      'default' => '10',
      'after'   => ' <i class="ash-text-muted">$ (dollars)</i>',
    ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => ' <i class="ash-text-muted">( this option is optional )</i>',
        ),
        ...
        array(
          ...
          'before' => '<i class="ash-text-muted">( important )</i> ',
        ),
        ...
        array(
          ...
          'after' => '<p class="ash-text-info">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="ash-text-muted">There is custom css <strong>style="width: 175px; height: 40px; border-color: #93C054;"</strong></p>',
        ),
        ...
        array(
          ...
          'after'      => '<p class="ash-text-muted">There is custom css <strong>style="width: 100%;"</strong></p>'
        ),
        ...
        array(
          ...
          'after'  => '<p class="ash-text-muted">This Text Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after' => '<p class="ash-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'before' => '<p class="ash-text-muted">Information: There is some description for option.</p> ',
        ),
        ...
        array(
          ...
          'after'      => '<p class="ash-text-muted">custom textarea attribute rows=10</p> ',
        ),
        ...
        array(
          ...
          'after'  => '<p class="ash-text-muted">This Textarea Field do not using left title, just using before text here. also you can remove it.</h4>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'         => '<p class="ash-text-muted"><strong>query_args:</strong> sort_order=desc, sort_column=post_title</p>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="ash-text-muted"><strong>query_args:</strong> post_type=your_post_type_name</div>',
        ),
        ...
        array(
          ...
          'after'       => '<div class="ash-text-muted"><strong>query_args:</strong> post_type=your_post_type_name, taxonomy=your_taxonomy_name</div>',
        ),
        ...
        array(
          ...
          'after'        => '<div class="ash-text-muted"><strong>query_args:</strong> taxonomies=your_taxonomy_name, order=asc, orderby=name</div>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<div class="ash-text-muted">Reference site about Lorem Ipsum, a random Lipsum generator.</div>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => ' <i class="ash-text-muted">(px)</i>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="ash-text-muted">Lets write some description for this icon field.</i>',
        ),
    ...
    array(
      ...
      'fields'    => array(
        ...
        array(
          ...
          'after'   => '<p class="ash-text-muted">You can use default value <strong>get_template_directory_uri()</strong>."/images/screenshot-1.png"</p>',
        ),
    ...
    array(
      ...
      'fields'      => array(
        ...
        array(
          ...
          'after'   => '<p class="ash-text-warning">This field using debug=true</p>',
          'debug'   => true,
        ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'type'     => 'text',
      'title'    => 'Requried Text',
      'after'    => ' <small class="ash-text-warning">( * required )</small>',
      'default'  => 'lorem ipsum',
      'validate' => 'required',
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Also you can add your own validate from <strong>themename/ash-framework/functions/validate.php</strong>',
    ),
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      ...
      'after'    => '<p class="ash-text-muted">This text field sanitized already, without any settings. we are using wordpress core.<br /> for eg. try too add <strong>&lt;p></strong> html tag</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="ash-text-muted">Disabled sanitize for this field (sanitize=false). try too add <strong>&lt;p></strong> html tag so, you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      ...
      'after'    => '<p class="ash-text-muted">This textarea field sanitized already, without any settings. we are using wordpress core.<br /> just allowing this tags wp core $allowedposttags</p>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="ash-text-muted">Disabled sanitize for this field (sanitize=false). you can write anything</p>',
      'sanitize' => false,
    ),
    ...
    array(
      'type'    => 'notice',
      'class'   => 'info',
      'content' => 'Custom Sanitize, Also you can add your own validate from <strong>themename/ash-framework/functions/sanitize.php</strong>',
    ),
    ...
    array(
      ...
      'after'    => '<p class="ash-text-muted">This text field sanitized as slug title (sanitize="title")</p>',
      'sanitize' => 'title',
    ),
...
ASHFramework::instance( $settings, $options );
