 ...
 *
 */
class ASHFramework_Option_Sorter extends ASHFramework_Options {
  ...
  public function output(){
    ...
    $enabled_title  = ( isset( $this->field['enabled_title'] ) ) ? $this->field['enabled_title'] : esc_html__( 'Enabled Modules', 'ash-framework' );
    $disabled_title = ( isset( $this->field['disabled_title'] ) ) ? $this->field['disabled_title'] : esc_html__( 'Disabled Modules', 'ash-framework' );

    echo '<div class="ash-modules">';
    echo '<h3>'. $enabled_title .'</h3>';
    echo '<ul class="ash-enabled">';
    if( ! empty( $enabled ) ) {
